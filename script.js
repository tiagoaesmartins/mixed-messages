...
const message = (animals, verbs, adjectives) => {
    ...
    console.log(`They told me my ${animals[animalIndex]} is ${adjectives[adjectivesIndex]} because I usually ${verbs[verbsIndex]} with vigour!`);
};

message(animals, verbs, adjectives);